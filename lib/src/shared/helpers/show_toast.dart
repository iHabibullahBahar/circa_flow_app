...
void showToast(
  ...
  final (backgroundColor, foregroundColor, iconColor) = switch (toastStatus) {
    ...
    _ => (
      context.contextTheme.scaffoldBackgroundColor,
  ...
  return ToastBar(
    ...
    builder: (context) => ToastCard(
      ...
      leading: effectiveIcon is IconData
          ? Icon(effectiveIcon, color: iconColor, size: 22.sp)
          : HugeIcon(icon: effectiveIcon, color: iconColor, size: 22.sp),
      title: Text(
        message,
