...
extension AppContextExtension on BuildContext {
  // ── Theme shortcuts ──────────────────────────────────────────────────────
  ThemeData get contextTheme => Theme.of(this);
  TextTheme get typography => contextTheme.textTheme;
  TextTheme get textTheme => contextTheme.textTheme;
  ColorScheme get colorScheme => contextTheme.colorScheme;
  ColorScheme get colors => contextTheme.colorScheme;
  bool get isDarkMode => contextTheme.brightness == Brightness.dark;

  /// Semantic/custom colors (success, warning, info).
  AppColorsExtension get appColors =>
      contextTheme.extension<AppColorsExtension>() ?? (isDarkMode ? AppPalettes.dark : AppPalettes.light);

  /// Design tokens (spacing, border radii, elevation defaults).
  AppDesignTokens get designTokens =>
      contextTheme.extension<AppDesignTokens>() ?? AppDesignTokens.fallback;
  ...
  // ── Platform ─────────────────────────────────────────────────────────────
  bool get isIOS => contextTheme.platform == TargetPlatform.iOS;
  bool get isAndroid => contextTheme.platform == TargetPlatform.android;
